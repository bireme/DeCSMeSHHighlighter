...
class DMFSiteServlet extends HttpServlet {
  var i18n: I18N = _
  ...
  override def init(config: ServletConfig): Unit = {
    ...
    println("DMFSiteServlet is listening ...")
  }
...
<html lang="""" + language + """">
   <head>
      ...
      <title>DeCSMeSH Finder - Site</title>
      <link rel="stylesheet" href="siteDeCSf/css/aos.css">
      <link rel="stylesheet" href="siteDeCSf/css/bootstrap.min.css">
      <link rel="stylesheet" href="siteDeCSf/css/fontawesome/css/all.css">
      <link rel="stylesheet" href="siteDeCSf/css/accessibility.css">
      <link rel="stylesheet" href="siteDeCSf/css/style.css">
      <link rel="stylesheet" href="siteDeCSf/css/aos.css">
      <link rel="shortcut icon" href="siteDeCSf/img/favicon.png">
   </head>
   <body id="body">
...
////alert("plang=" + plang + " toWizard="  + toWizard);
            ...
            if (toWizard) {
              form.setAttribute("action", "dmfw");
              form.setAttribute("target", "_blank");
            }
            else form.setAttribute("action", "dmfs");
      ...
      <section class="padding1" id="howToSection">
         <div class="container" id="boxUse">View your result
            <div class="row" id="howTo">
               ...
               <div class="col-md-4">
                  <img src="siteDeCSf/img/copy.svg" alt="">
                  <div class="howToText">
               ...
               <div class="col-md-4">
                  <img src="siteDeCSf/img/paste.svg" alt="">
                  <div class="howToText">
               ...
               <div class="col-md-4">
                  <img src="siteDeCSf/img/result.svg" alt="">
                  <div class="howToText">
      ...
      <section class="padding1">
         <div class="container">
            ...
            <div class="row">
               ...
               <div class="col-md-4">
                  <img src="siteDeCSf/img/notebook.jpg" alt="" class="img-fluid">
               </div>
            </div>
         </div>
      </section>
                     ...
                     <div class="card">
                        <div class="card-header" id="headingFive">
                           <h2 class="mb-0">
                              ...
                              """ + i18n.translate("How do I find the DeCS/MeSH terms on my web pages", language) + """?
                              </button>
                           </h2>
                        </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-8 col-lg-6 text-center" id="siteDeCS">
                  <h1>
                     <a href="https://decs.bvsalud.org/""" + (if (language.equals("pt")) "" else language) + """" class="" target="_blank">""" + i18n.translate("Access the DeCS/MeSH website", language) + """.</a>
                  </h1>
               </div>
               <div class="col-md-4 col-lg-6 text-center">
                  <img src="siteDeCSf/img/siteDeCS.png" alt="Site DeCS/MeSH" class="img-fluid">
               </div>
            </div>
         </div>
      </section>
          ...
          <div class="container">
              <div class="row">
                  ...
                  <div class="col-md-7 text-right">
                       <!--a href="https://www.paho.org/""" + (if (language.equals("fr")) "en" else language) + """/bireme>" target="_blank" </a-->
      ...
      <script src="siteDeCSf/js/jquery-3.5.1.min.js"></script>
      <script src="siteDeCSf/js/bootstrap.min.js"></script>
      <script src="siteDeCSf/js/cookie.js"></script>
      <script src="siteDeCSf/js/accessibility.js"></script>
      <script src="siteDeCSf/js/aos.js"></script>
      <script src="siteDeCSf/js/main.js"></script>
      ...
      <div id="lvztr_de9" style="display:none"></div><script id="lz_r_scr_74aeee9c36e59281529443e9e1a975d3" type="text/javascript" defer>lz_code_id="74aeee9c36e59281529443e9e1a975d3";var script = document.createElement("script");script.async=true;script.type="text/javascript";var src = "//contacto.bvsalud.org/server.php?rqst=track&output=jcrpt&operator=morimarc&group=DeCSMeSH%Finder&hg=Pw__&hcgs=MQ__&htgs=MQ__&hinv=MQ__&hfk=MQ__&nse="+Math.random();script.src=src;document.getElementById('lvztr_de9').appendChild(script);</script>
      <!-- livezilla.net PLACE SOMEWHERE IN BODY -->
   </body>
</html>
    """
