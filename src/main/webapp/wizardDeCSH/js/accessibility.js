...
jQuery(document).ready(function(){
	...
	var font16 = 16; var class16 ='.font16, p, #nav, .navFooter li a, .breadcrumb, .accordion, .accordion button, #wizard, .form-control, .custom-control-label, .modal-body h5'; // inserir elementos com fonte 16px
	var font20 = 20; var class20 ='.font20, .wizardModalTitle h4'; // inserir elementos com fonte 20px
